...
bouton_measurer_exp_PSD95.py and full_image_actin_measurer_exp.py) of all rois and the whole actin images 
...
output_directory = '/Users/jakobrentsch/FU Box/Papers/Dual color sted of actin and syp/Expansion data/20241120_Data_for_jakob/Channel Split/Source Data/PSD95'
conditions = ['WT', 'TKO']
...
def csv_files_summarizer(directoy, condition):
    ...
    for root, dirs, files in os.walk(input_directory):
        for file in files:
            ...
            if file.endswith("final_table_PSD95.csv") and condition in root:
